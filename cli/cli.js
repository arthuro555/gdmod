...
program
  ...
  .description(
    "Install the loader and apply patches to an unpacked GDevelop game"
  )
  .action((directory, args) => {
    const currentLoader = args.electron
      ? loader.installGDModElectron
      : loader.installGDMod;
    currentLoader(directory).catch(() => {

declare namespace gdjs {
    namespace evtTools {
        namespace sound {
            const getGlobalVolume: (runtimeScene: gdjs.RuntimeScene) => number;
            ...
            const getSoundOnChannelVolume: (runtimeScene: gdjs.RuntimeScene, channel: integer) => number;
            const setSoundOnChannelVolume: (runtimeScene: gdjs.RuntimeScene, channel: integer, volume: float) => void;
            const getSoundOnChannelPlayingOffset: (runtimeScene: gdjs.RuntimeScene, channel: integer) => number;
            const setSoundOnChannelPlayingOffset: (runtimeScene: gdjs.RuntimeScene, channel: integer, playingOffset: float) => void;
            const getSoundOnChannelPitch: (runtimeScene: gdjs.RuntimeScene, channel: integer) => number;
            ...
            const getMusicOnChannelVolume: (runtimeScene: gdjs.RuntimeScene, channel: integer) => number;
            const setMusicOnChannelVolume: (runtimeScene: gdjs.RuntimeScene, channel: integer, volume: float) => void;
            const getMusicOnChannelPlayingOffset: (runtimeScene: gdjs.RuntimeScene, channel: integer) => number;
            const setMusicOnChannelPlayingOffset: (runtimeScene: gdjs.RuntimeScene, channel: integer, playingOffset: float) => void;
            const getMusicOnChannelPitch: (runtimeScene: gdjs.RuntimeScene, channel: integer) => number;

declare namespace gdjs {
    namespace evtTools {
        namespace input {
            ...
            const getTouchX: (runtimeScene: any, identifier: any, layer: any, camera: any) => any;
            const getTouchY: (runtimeScene: any, identifier: any, layer: any, camera: any) => any;
            const getLastTouchId: () => number;
            const getLastEndedTouchId: () => number;
            const popStartedTouch: (runtimeScene: any) => boolean;
            const popEndedTouch: (runtimeScene: any) => boolean;
